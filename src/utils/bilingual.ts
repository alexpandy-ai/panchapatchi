...
export const UI = {
  ...
  refreshDefaults: bi("மீட்டமை", "Refresh"),
  locationPermissionOn: bi("இட அனுமதி இயக்கத்தில்", "Location permission on"),
  ...
  vazhipattuThalangal: bi("வழிபாட்டு தலங்கள்", "Worship Places"),
  templePlace: bi("கோவில் / தலம்", "Temple / Place"),
  pandavas: bi("பாண்டவர்கள்", "Pandavas"),
  siddhar: bi("சித்தர்", "Siddhar"),
  devas: bi("தேவர்கள்", "Devas"),
  otherMatches: bi("மற்ற பொருத்தங்கள்", "Other matches"),
